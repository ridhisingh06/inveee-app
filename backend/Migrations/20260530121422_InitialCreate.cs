    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleItemLimits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleItemLimits_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleItemLimits_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalLogs_Requests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IssueLogs_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReceivedLogs_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueLogs_RequestId",
                table: "IssueLogs",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueLogs_UserId",
                table: "IssueLogs",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceivedLogs_RequestId",
                table: "ReceivedLogs",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ReceivedLogs_UserId",
                table: "ReceivedLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrationRequests_ApprovedUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleItemLimits_ItemId",
                table: "RoleItemLimits",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleItemLimits_RoleId",
                table: "RoleItemLimits",
                column: "RoleId");
