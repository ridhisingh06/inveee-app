...
namespace invmgmt.web.Migrations
{
    ...
    [Migration("20260711074416_AddPartialIssueApprovalAndOrderSummary")]
    partial class AddPartialIssueApprovalAndOrderSummary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("invmgmt.web.Models.OrderSummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TotalApprovedQuantity")
                        .HasColumnType("integer");

                    b.Property<int>("TotalIssuedQuantity")
                        .HasColumnType("integer");

                    b.Property<int>("TotalReceivedQuantity")
                        .HasColumnType("integer");

                    b.Property<int>("TotalRejectedQuantity")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("invmgmt.web.Models.OrderSummaryItem", b =>
                {
                    ...
                    b.Property<int>("AdminRejectedQuantity")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("IssuerRejectedQuantity")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("invmgmt.web.Models.RequestItem", b =>
                {
                    ...
                    b.Property<int>("AdminApprovedQuantity")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("IssuerIssuedQuantity")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("invmgmt.web.Models.OrderSummary", b =>
                {
                    b.HasOne("invmgmt.web.Models.User", "ApprovedByUser")
                        .WithMany()
                        .HasForeignKey("ApprovedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("invmgmt.web.Models.User", "IssuedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("invmgmt.web.Models.OrderSummaryItem", b =>
                {
                    ...
                    b.HasOne("invmgmt.web.Models.OrderSummary", "OrderSummary")
                        .WithMany("Items")
                        .HasForeignKey("OrderSummaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("invmgmt.web.Models.RequestItem", "RequestItem")
                        .WithMany()
